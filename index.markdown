...
By day, I design, automate, and troubleshoot enterprise application delivery platforms, load balancing (BIG-IP LTM), DNS (BIG-IP DNS/GTM), WAFs (BIG-IP ASM (WAF/AWAF/BoT/DDoS)), and the iRules nobody else wants to touch.<br />
<br />
